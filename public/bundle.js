...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavHeader = __webpack_require__(235);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavLink = __webpack_require__(236);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TimerComponent = __webpack_require__(238);
	...
	var HomePage = function HomePage() {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'h2',
	      null,
	      'Some Timer Components'
	    ),
	    _react2.default.createElement(_TimerComponent2.default, {
	      startTime: 0,
	      stopTime: 5,
	      countRate: 1000
	    }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TimerDisplay = __webpack_require__(239);

	var _TimerDisplay2 = _interopRequireDefault(_TimerDisplay);
	...
	var TimerComponent = function (_Component) {
	  ...
	  function TimerComponent(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TimerComponent).call(this, props));

	    _this.currentTime = props.startTime;
	    _this.stopTime = props.stopTime;
	    _this.countRate = props.countRate;

	    // Set the initial state
	    //——————————————————————
	    _this.state = {
	      count: _this.currentTime
	    };
	    return _this;
	  }
	  ...
	  _createClass(TimerComponent, [{
	    ...
	    value: function tick() {
	      ...
	      this.timer = setInterval(function () {
	        _this2.currentTime < _this2.stopTime ? _this2.currentTime++ : _this2.currentTime--;

	        // Set state to new current time
	        //——————————————————————————————
	        _this2.setState({
	          count: _this2.currentTime
	        });

	        if (_this2.currentTime === _this2.stopTime) {
	    ...
	    value: function render() {
	      ...
	      //——————————————————————————————————————
	      return _react2.default.createElement(_TimerDisplay2.default, { count: this.state.count });
	    }
	  }]);
	...
	TimerComponent.propTypes = {
	  ...
	  stopTime: _react.PropTypes.number.isRequired,
	  countRate: _react.PropTypes.number.isRequired
	};
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        "p",
	        null,
	        "React provides two ways to handle/share data: \"props\" and \"state\"."
	      ),
	      _react2.default.createElement(
	        "h3",
	        null,
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "span",
	            null,
	            "Declare props by passing them down as attributes."
	          ),
	          _react2.default.createElement(
	            "code",
	            null,
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "span",
	            null,
	            "Now startTime is accessible within TimerComponent."
	          ),
	          _react2.default.createElement(
	            "code",
	            null,
	        ...
	        _react2.default.createElement(
	          "p",
	          null,
	          "Only thing is, they're READ ONLY!"
	        ),
	        _react2.default.createElement(
	          "p",
	          null,
	          "In other words, they can't be changed... ever."
	        ),
	        _react2.default.createElement(
	          "p",
	          null,
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "span",
	            null,
	            "In this demo props are only used to control the timer."
	          ),
	          _react2.default.createElement("br", null),
	          _react2.default.createElement(
	            "span",
	            null,
	            "This way, currentTime can be assigned props.startTime and changed later."
	          ),
	          _react2.default.createElement(
	            "code",
	            null,
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "span",
	            null,
	            "Props can be displayed just as well."
	          ),
	          _react2.default.createElement(
	            "code",
	            null,
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "span",
	            null,
	            "Initialize the TimerComponent state inside the constructor() method."
	          ),
	          _react2.default.createElement(
	            "code",
	            null,
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "span",
	            null,
	            "In order to change state it must be done using the setState() method."
	          ),
	          _react2.default.createElement(
	            "code",
	            null,
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "span",
	            null,
	            "Just like props, state CANNOT be changed like this ..."
	          ),
	          _react2.default.createElement(
	            "code",
	            null,
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "p",
	          null,
	          "– These limitations will encourage thoughtful data manipulation and forward thinking."
	        ),
	        _react2.default.createElement(
	          "p",
	          null,
	          "– Once these concepts sink in, it's probably time to learn about the Flux architecture for managing state."
	        )
	      )
	    )
	  );
